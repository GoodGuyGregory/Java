public class Thing {
  ...
  // RUNNING: clear && javac Thing.java && java Thing
  public static void main(String[] args) {
    ...
    explore("Objects references use double equals to check if they refer to the same object",
        firstObject != secondObject);

    Object sameObject = firstObject;
    explore("Object references must refer to the same object to use double equals", sameObject == firstObject);

    String firstString = "Craig";
    String secondString = "Craig";
    explore("String literals are actually refferring to the same object", firstString == secondString);

    String differentString = new String("Craig");
    explore("Strings objects that contain the same characters but point to different objects cannot use double equals",
        firstString != differentString);

    String anotherString = new String("Craig");
    explore(
        "String Interning adds to the same String Pool where literals live, so you get back the same references if it exisits",
